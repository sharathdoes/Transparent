...
const SheetTitle = React.forwardRef((props, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn('text-lg font-bold text-text dark:text-darkText', props.className)}
    {...props}
  />
))
...
const SheetDescription = React.forwardRef((props, ref) => (
  <SheetPrimitive.Description
    ref={ref}
    className={cn('text-sm font-base text-text dark:text-darkText', props.className)}
    {...props}
  />
))
